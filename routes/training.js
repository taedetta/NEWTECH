...
const trainingStaffOnly = [authenticateToken, requireRole('owner', 'admin', 'instructor')];
...
router.get('/program-enrollments', authenticateToken, async (req, res) => {
  try {
    // Training staff can view all enrollments; students/renters/maintenance cannot.
...
router.post('/student-progress', ...trainingStaffOnly, async (req, res) => {
  try {
...
router.put('/enrollment/:id/stage', ...trainingStaffOnly, async (req, res) => {
  try {
...
router.put(['/admin/programs/:id(\\d+)', '/programs/:id(\\d+)'], ...adminOnly, async (req, res) => {
  try {
...
router.delete(['/admin/programs/:id(\\d+)', '/programs/:id(\\d+)'], ...adminOnly, async (req, res) => {
...
router.put(['/admin/stages/:id(\\d+)', '/stages/:id(\\d+)'], ...adminOnly, async (req, res) => {
  try {
...
router.delete(['/admin/stages/:id(\\d+)', '/stages/:id(\\d+)'], ...adminOnly, async (req, res) => {
  try {
...
router.put(['/admin/maneuvers/:id(\\d+)', '/maneuvers/:id(\\d+)'], ...adminOnly, async (req, res) => {
  try {
...
router.delete(['/admin/maneuvers/:id(\\d+)', '/maneuvers/:id(\\d+)'], ...adminOnly, async (req, res) => {
  try {
...
router.post('/debriefs', ...trainingStaffOnly, async (req, res) => {
  try {
...
router.post('/milestones', ...trainingStaffOnly, async (req, res) => {
  try {
