...
const { EMAIL_TYPES, OPTIONAL_EMAIL_TYPES } = require('../lib/email-types');
const { getPreferenceCatalog } = require('../lib/notification-prefs');
...
router.patch('/email-preferences', authenticateToken, async (req, res) => {
  try {
    ...
    for (const key of OPTIONAL_EMAIL_TYPES) {
