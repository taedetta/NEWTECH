  ...
  try {
    ...
    if (isRequiredEmailType(rawType)) {
      return res.status(400).send(renderPage({
        ...
        message: 'Password reset emails are required for account access and cannot be unsubscribed. Sign in and open My Account to manage other email preferences.',
      }));
    }
