...
function renderDiscoveryFlightArticle(article) {
  ...
  const body = `
    ...
    <p>A discovery flight — also called an introductory flight or intro lesson — is a structured introductory flight with a certified flight instructor (CFI). This is hands-on flight training: you're in the left seat (the pilot's seat) and you're handling the controls.</p>
