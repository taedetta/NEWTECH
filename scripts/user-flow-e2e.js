...
if (!process.env.DATABASE_URL) {
  console.error('DATABASE_URL is required for user-flow E2E because this script writes and cleans test data.');
  process.exit(1);
}
if (!ADMIN_PASS) {
  console.error('ADMIN_PASSWORD is required for user-flow E2E.');
  process.exit(1);
}
