...
const OWNER = {
  email: process.env.LOCAL_OWNER_EMAIL || 'local-admin@test.local',
  name: process.env.LOCAL_OWNER_NAME || 'Local Admin',
  password: process.env.LOCAL_OWNER_PASSWORD || `local-${crypto.randomBytes(18).toString('base64url')}`,
  role: 'admin',
};
