...
function validateBookingTimes({ start, end, local_start, local_end, policy, userRole, isAdmin, booking_type, lesson_type, skipDiscoveryDurationCheck }) {
  const errors = [];
  const warnings = [];
...
async function runPreflightChecks(client, { aircraft_id, student_id, instructor_id, start_time, end_time, booking_type, lesson_type, local_date, local_start, local_end }, userRole) {
