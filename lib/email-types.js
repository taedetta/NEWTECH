...
const REQUIRED_EMAIL_TYPES = {
  password_reset: EMAIL_TYPES.password_reset,
  account_approved: EMAIL_TYPES.account_approved,
  account_rejected: EMAIL_TYPES.account_rejected,
  signup_pending: EMAIL_TYPES.signup_pending,
  account_invite: EMAIL_TYPES.account_invite,
  profile_change: EMAIL_TYPES.profile_change,
  welcome: EMAIL_TYPES.welcome,
};

const OPTIONAL_EMAIL_TYPES = Object.fromEntries(
  Object.entries(EMAIL_TYPES).filter(([, value]) => !Object.values(REQUIRED_EMAIL_TYPES).includes(value))
);
