...
const OPTIONAL_EMAIL_TYPES = Object.fromEntries(
  Object.entries(EMAIL_TYPES).filter(([key]) => !REQUIRED_EMAIL_TYPES[key])
);
...
const TYPE_CATEGORIES = [
  ...
  },
  {
    ...
    types: ['profile_change', 'signup_pending', 'account_approved', 'account_rejected', 'account_invite', 'welcome'],
  },
  {
    id: 'operations',
