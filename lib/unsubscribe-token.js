...
function normalizeUnsubscribeType(type) {
  ...
  if (EMAIL_TYPES[type] && !REQUIRED_EMAIL_TYPES[type]) return type;
  return null;
}

/** Token binds the user and the exact preference type being changed. */
