...
const { sendEmail, bookingConfirmationEmail, flightCancelledEmail } = require('../email-templates');
...
async function sendBookingConfirmationEmails(bookingId, db) {
  ...
  if (b.student_email) {
    ...
    sends.push(sendEmail(b.student_email, tpl.subject, tpl.html, tpl.text));
  }
  ...
  if (b.instructor_email && b.instructor_id !== b.student_id) {
    ...
    sends.push(sendEmail(b.instructor_email, tpl.subject, tpl.html, tpl.text));
